...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Panel de administración | Inventario de aceites de olivo</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:5px" src="assets/img/logo1.png" alt="Logo"> 
          <span style="font-size:20px">San Salvador</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="http://hangouts.google.com" target="_blank">VOIP</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
