...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Login | Inventario de aceites de olivo</title>
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo1.png" alt="Logo" height="50"> <b>San Salvador</b>
      </div><!-- /.login-logo -->
      <?php  
	...
	<img src="img/info.png" width="400" height="300">
