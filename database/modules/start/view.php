  ...
  <section class="content">
      ...
      <div class="col-lg-12 col-xs-12">
        <div class="alert alert-info alert-dismissable">
          ...
          <p style="font-size:15px">
            <i class="icon fa fa-user"></i> Bienvenido <strong><?php echo $_SESSION['name_user']; ?></strong> a la aplicación de inventario de San Salvador.
          </p>        
        </div>
      </div>  
    </div>
    ...
    <video src="img/envasado.mp4" controls play width="520" height="280"></video>
<br>
<br>
<br>
<center>
	<img src="img/ra.jpeg" width="500" height="300">